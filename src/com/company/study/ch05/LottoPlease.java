...
public class LottoPlease {
	...
	public static void main(String[] args) {
		...
		while(isSameNumber||isLinearNumber||isSameOldNumber) {
			...
			// 연속숫자 거르기
			for(int i=0; i<4; i++) {
				if(lotto[i]+1 == lotto[i+1] && lotto[i]+2 == lotto[i+2]) {
					System.out.println("걸렸다.: " + lotto[i] + " : " + lotto[i+1] + " : " + lotto[i+2]);
					isLinearNumber = true;
					break;
				} else {
			...
			if(isSameNumber || isLinearNumber || isSameOldNumber) {
				System.out.println("다시 시도해 주세요: " + randomString);
			} else {
